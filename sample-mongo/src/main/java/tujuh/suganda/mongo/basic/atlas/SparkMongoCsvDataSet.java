...
public class SparkMongoCsvDataSet implements Serializable {
	public static void main(String[] args) throws IOException {

		SparkConf sparkConf = new SparkConf().setAppName("SparkCsvReader").setMaster("local[2]")
				.set("spark.mongodb.output.uri", "mongodb://root:aing@galaucluster-shard-00-00-mweoa.mongodb.net:27017,galaucluster-shard-00-01-mweoa.mongodb.net:27017,galaucluster-shard-00-02-mweoa.mongodb.net:27017/my_app.mencoba?ssl=true&replicaSet=GalauCluster-shard-0&authSource=admin");
				...
				.map(new Function<String, String>() {
					...
					public String call(String value) throws Exception {
						...
						try {
							...
							json = SparkMongoCsvDataSet.jsonParse(model);
						} catch (Exception e) {
						}
						return json;
					}
		...
		// Upsert
		MongoSpark.write(myDs).option("collection", "mencoba").mode("overwrite").save();
		jsc.close();
