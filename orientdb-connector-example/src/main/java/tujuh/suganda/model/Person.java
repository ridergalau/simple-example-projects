...
public class Person{
	...
	public Person(String _key, String firstname, String lastname, Map<String, String> address, List<String> hobies,
	...
	public Person(String _key, String firstname, String lastname, BigInteger timestamp, String gender, String email) {
		super();
		this._key = _key;
		this.firstname = firstname;
		this.lastname = lastname;
	...
	public Person(String _key, String firstname, String lastname, String gender, String email) {
		super();
		this._key = _key;
		this.firstname = firstname;
		this.lastname = lastname;
