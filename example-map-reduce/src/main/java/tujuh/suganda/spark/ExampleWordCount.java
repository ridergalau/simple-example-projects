...
public class ExampleWordCount {
	public static void main(String[] args) {
		SparkConf conf = new SparkConf().setMaster("local[3]").setAppName("SparkArangoDb");
		...
		/*
		 * //Word Count JavaPairRDD<String, Integer> counts = textFile .flatMap(s ->
		...
		// PairFunction<String, String, String> keyData = new PairFunction<String,
		// String, String>() {
		// public Tuple2<String, String> call(String x) {
